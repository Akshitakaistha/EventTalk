...
//         </button>
//         <button 
//           className="px-3 py-2 border border-gray rounded-md shadow-sm text-sm font-medium bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
//           onClick={onPublish}
//         >
//           Publish
//         </button>
    ...
    <header className="bg-white border-b border-gray-200 px-4 py-3 flex flex-col">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button 
            className="px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium  bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
            onClick={onPublish}
          >
            Publish
          </button>
